...
public class UserRestController {
    @Autowired
    private RepositoryUser repositoryUser; // Repositorio para acceder a usuarios
    @Autowired
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('SUPER_ADMIN')") // Solo SUPER_ADMIN puede acceder
    ...
    public ResponseEntity<?> addUser(@RequestBody User user, HttpServletRequest request) {
        ...
        user.setPassword(passwordEncoder.encode(user.getPassword())); // Codificamos contraseña
        user.setRole(optionalRole.get()); // Asignamos rol USER
    ...
    public ResponseEntity<?> disableUser(@PathVariable Long userId, HttpServletRequest request) {
        ...
        if (userOptional.isPresent()) {
            ...
            repositoryUser.save(user); // Guardamos cambios
